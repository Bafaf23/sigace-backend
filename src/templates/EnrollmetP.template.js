                  ...
                  <section class="mb-10">
                      ...
                      <div class="flex -mx-1 mt-2">
                          <div class="w-full px-1 mb-[5px]">
                              ...
                              <div class="text-[12px] text-[#1E293B] py-[6px] border-b border-[#CBD5E1] min-h-[20px] uppercase font-bold  text-[#1E293B]">${student.condition || "NUEVO INGRESO"}</div>
                          </div>
                          <div class="w-full px-1 mb-[5px]">
                          ...
                          <div class="w-full px-1 mb-[5px]">
                              <label class="text-[12px] font-bold text-[#94A3B8] block uppercase tracking-wide">Seccion</label>
                              <div class="text-[12px] text-[#1E293B] py-[6px] border-b border-[#CBD5E1] min-h-[20px] uppercase font-bold text-[#1E293B]">${student.section_name || "NUEVO INGRESO"}</div>
                          </div>
                      </div>
                  </section>
                  ...
                  <section class="mb-10">
                      ...
                      <div class="flex -mx-1">
                          ...
                          <div class="w-[25%] px-1 mb-[5px]">
                              ...
                              <div class="text-[12px] text-[#1E293B] py-[6px] border-b border-[#CBD5E1] min-h-[20px] uppercase font-bold">
